    ...
    <div className=" font-mono bg-gray-50 min-h-screen flex flex-col">
        ...
        <div className="w-full px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <img
              ...
              alt="Logo"
            />
            <span className="font-mono text-xl font-extrabold text-red-700">Smart Blood Hub</span>
          </div>
      ...
      <section className="relative h-[400px] w-full">
        ...
        <div className="absolute inset-0  bg-opacity-50 flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <button  onClick={() => goToDonate && goToDonate()}
          className="mt-5 bg-red-600 hover:bg-red-700 px-6 py-2 rounded text-white font-medium">
            Become a Donor
          </button>
        </div>
      </section>
        ...
        <section key={index} className="py-16 bg-white w-full">
          <div className={`w-full flex flex-col md:flex-row ${s.reverse ? 'md:flex-row-reverse' : ''} items-center`}>
            ...
            <div className="w-full md:w-1/2 p-6 md:p-12 text-center md:text-left">
              <h2 className="font-mono text-3xl font-bold text-red-700 mb-4">{s.title}</h2>
              <p className="font-mono text-gray-600 text-lg">{s.text}</p>
            </div>
          </div>
        </section>
      ))}
